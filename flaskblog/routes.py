...
#import login related libraries
from flask_login import login_user,current_user,logout_user,login_required

#import Image manipulation libraries
from PIL import Image

#import send gmail libraries
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request',sender='noreply@blog.com',
...
def reset_token(token):
    ...
    if user is None:
        flash('That is an invalid or exired token','warning')
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(f'Your Password has been Updated, You can now login with the new password','success')
        return redirect(url_for('login'))
